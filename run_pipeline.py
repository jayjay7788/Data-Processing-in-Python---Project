...
def run_all():
    ...
    if dl_choice in ['y', 'yes']:
        ...
        print("⏭️ Skipping download. (Using existing raw data)")
    ...
    if pr_choice in ['y', 'yes']:
        ...
        print("⏭️ Skipping processing. (Using existing processed_data.csv)")
    ...
    if tr_choice in ['y', 'yes']:
        ...
        print("⏭️ Skipping training. (Using existing compressed model bundle)")
